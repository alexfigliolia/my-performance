...
export type TeammateProfileQuery = { __typename?: 'Query', teammateProfile: { __typename?: 'OverallStatsPerUser', id: number, name: string, lines: number, commits: number, linesPerMonth: Array<number> } };
