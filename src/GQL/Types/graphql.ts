...
export type UserAndAffiliationsFragmentFragment = { __typename?: 'UserAndAffiliations', user: { __typename?: 'User', id: number, name: string, email: string, verified: boolean }, organizations: Array<{ __typename?: 'BaseOrganizationAndUserRole', id: number, name: string, platform: Platform, role: UserRole }> };

export type VerifySessionMutationVariables = Exact<{ [key: string]: never; }>;


export type VerifySessionMutation = { __typename?: 'Mutation', verifySession: { __typename?: 'UserAndAffiliations', user: { __typename?: 'User', id: number, name: string, email: string, verified: boolean }, organizations: Array<{ __typename?: 'BaseOrganizationAndUserRole', id: number, name: string, platform: Platform, role: UserRole }> } };
