...
export type OverallStatsPerUserQuery = { __typename?: 'Query', overallStatsPerUser: { __typename?: 'TeamStats', name: string, totalLines: number, totalCommits: number, users: Array<{ __typename?: 'OverallStatsPerUser', id: number, name: string, lines: number, commits: number, linesPerMonth: Array<number> }> } };
